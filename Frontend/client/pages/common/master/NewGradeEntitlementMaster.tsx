...
import { Plus, Edit2, Trash2, Search, Filter, Plane, Train, Car, Hotel, CheckCircle, XCircle, ChevronDown } from "lucide-react";
                        ...
                        {options.length === 0 ? (
                            ...
                            options.map(option => (
                                ...
                                >
                                    ...
                                    />
                                    <span className="ml-2 text-sm text-slate-700">{option[labelKey]}</span>
                                </label>
                            ))
                        )}
                    </div>
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (selectedItem) {
                ...
                await travelAPI.bulkCreateGradeEntitlements({ records: recordsToCreate });
                toast({
                    title: "Success",
